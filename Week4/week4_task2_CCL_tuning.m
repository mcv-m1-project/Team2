...
thresholdDT0_vec = [22500, 25000, 27500, 30000, 32500, 35000];



%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Loop over different thresholds:
for i = 1:length(thresholdDT0_vec)
    thresholdDT0 = thresholdDT0_vec(i);
    fprintf('\n(%i/%i)  thresholdDT0 = %f\n', i, length(thresholdDT0_vec), thresholdDT0)
