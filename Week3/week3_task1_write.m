function [CC_list]  = week3_task1_write(dirmask, outdir)
...
mask_file_list = get_filenames(dirmask, 'mask');
n_mask = length(mask_file_list);    % Number of files found

for i=1:n_mask
    mask_file = [dirmask, '\', mask_file_list{i}, '.png'];
    ...
    % Write mask:
    imwrite(clean_mask, [outdir, '\', mask_file_list{i}, '.png'])
