function houghDetectSignal(dirTestImages, inputWindowsDir, outputDir, delta_theta_90, delta_theta_30, delta_theta_0, grdthres, fltr4LM_R)
%HOUGHDETECTSIGNAL
     ...
     for i=1:nFiles
         ...
         if((window.x == 0) || (window.y == 0) || (window.w == 0) || (window.h == 0))
             ...
             for idx=1:size(windowCC.windowCandidates,2)
                 ...
                 mask_windowed = mask(window.y:window.y+window.h-1, window.x:window.x+window.w-1, :);
                 ...
                 if((triangle_detected == true) || (square_detected == true) || (circle_detected == true))
                     out_mask(window.y:window.y+window.h-1, window.x:window.x+window.w-1) = mask_windowed | out_mask(window.y:window.y+window.h-1, window.x:window.x+window.w-1);
